...
public struct Styles {
    public static let lineChartStyleOne = ChartStyle(
        ...
        chartBodyGradient: GradientColors.bluPurpl,
...
public class ChartStyle {
    ...
    public var chartBodyGradient: GradientColor
    public weak var darkModeStyle: ChartStyle?
    
    public init(backgroundColor: Color,
                accentColor: Color,
                secondGradientColor: Color,
                chartBodyGradient: GradientColor,
                textColor: Color,
        ...
        self.chartBodyGradient = chartBodyGradient
    }
    ...
    public init(formSize: CGSize){
        ...
        self.chartBodyGradient = GradientColors.bluPurpl
    }
}
