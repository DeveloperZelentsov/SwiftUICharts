...
public struct Line: View {
    ...
    var lineGradient: GradientColor
    var chartBodyGradient: GradientColor
    var index:Int = 0
    ...
    public var body: some View {
        ZStack {
            if(self.showFull && self.showBackground){
                self.closedPath
                    .fill(LinearGradient(gradient: chartBodyGradient.getGradient(), startPoint: .bottom, endPoint: .top))
